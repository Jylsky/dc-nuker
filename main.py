...
- This script is educational and fully coded by subjoel.


✨ Bruh Nuker. A defferant nuker that you can enjoy it cool features ✨
- https://github.com/subjoel/dc-nuker
...
"""
    ...
    if choice == "99":
        ...
        counts = Funcs.get_input("how many times do you want to send the message? [1, ∞]: ", lambda x: x.isnumeric() and int(x) != 0)
